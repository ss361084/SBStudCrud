...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/static/css/CustomCss.css">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/CustomJs.js"></script>
	</head>
</html>
